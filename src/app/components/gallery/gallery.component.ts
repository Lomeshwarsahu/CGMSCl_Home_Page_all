...
Infrastructure: string[] = [
  ...
  openModalDrug(index: number) {
    this.selectedIndex = index;
    const modal = new bootstrap.Modal(document.getElementById('DrugimageModal'));
    modal.show();
  ...
  openModalCivil(index: number) {
    this.selectedIndex = index;
    const modal = new bootstrap.Modal(document.getElementById('InfrastructureimageModal'));
    modal.show();
  ...
  openModalEquipment(index: number) {
    this.selectedIndex = index;
    const modal = new bootstrap.Modal(document.getElementById('equipmentimageModal'));
    modal.show();
  ...
  prevImageCivil() {
    this.selectedIndex =
      (this.selectedIndex - 1 + this.Infrastructure.length) % this.Infrastructure.length;
  }
